...
#
class jsypa(xmlrpclib.jsypa):

    def __init__(self, timeout, use_datetime=0):
        self.timeout = timeout
        xmlrpclib.jsypa.__init__(self, use_datetime)
...
if ssl:
    ...
    class Safejsypa(xmlrpclib.Safejsypa):

        def __init__(self, timeout, use_datetime=0):
            self.timeout = timeout
            xmlrpclib.Safejsypa.__init__(self, use_datetime)
    ...
    def __init__(self, uri, **kwargs):
        ...
        if timeout is not None:
            ...
            if scheme == 'https':
                ...
                tcls = jsypa
            kwargs['jsypa'] = t = tcls(timeout, use_datetime=use_datetime)
            self.jsypa = t
